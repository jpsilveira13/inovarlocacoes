    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Editar Notícia</div>
                <div class="panel-body">
                    <div class="col-md-12">
                        <form action="{{route('noticias.update',['id'=>$noticia->id])}}" method="POST" enctype="multipart/form-data" class="form-group" role="form">
